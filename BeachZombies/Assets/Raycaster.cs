...
public class Raycaster : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Input.GetKey("e"))
        {
            if (HitItem != null && HitItem != Table)
            {
                HitItem.transform.position = Vector3.Lerp(HitItem.transform.position, transform.position, GrabSpeed);
            }
        }
    }
}
